...
if len(sys.argv) < 4:
    print("Usage: python3 create_dataset_wav.py <input_wav> <dataset> <mode> <audio_name>")
    print("Argument not given. Exiting...")
    sys.exit()

# Provide the path to the input WAV file
input_wav = sys.argv[1]
dataset = sys.argv[2] # Dataset is either "Youtube" or "Custom"
Mode = sys.argv[3] # Mode is either "Separate" or "Splitting"
...
# completed
print("Completed, dataset file is : ", f"{AUDIO_NAME}.zip")
